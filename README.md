...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=5804&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/scyjava-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `scyjava` can be installed with `conda`:
...
```
mamba install scyjava
```

It is possible to list all of the versions of `scyjava` available on your platform with `conda`:
...
```
mamba search scyjava --channel conda-forge
```
...
mamba repoquery search scyjava --channel conda-forge

# List packages depending on `scyjava`:
mamba repoquery whoneeds scyjava --channel conda-forge

# List dependencies of `scyjava`:
mamba repoquery depends scyjava --channel conda-forge
```
